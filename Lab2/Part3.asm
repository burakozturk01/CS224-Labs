.data
	...
	arrSizeMsg: .asciiz "Please enter array size (max: 16): "
	arrayMsg: .asciiz "Please enter array elements one by one: "
...
.text
	...
	getArray:
		...
		# Make dummy register for writing array
		move $t1, $s0
		...
		while3:
			beq $t0, $s1, stop3 # Stopping loop when counter hits array size number
			...
			# Move address register one forward
			add $t1, $t1, 4
