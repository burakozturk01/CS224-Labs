...
dupeLoop:
	...
	# If next node's address is 0 in original list, we are done
	beq $s1, $zero, dupeDone
	
	j dupeLoop

dupeDone:

# Make last node's address byte is zero
addi $s3, $s3, -8
sw $zero, 0($s3)
